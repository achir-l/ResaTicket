...
namespace ResaTicket.Data.Migrations
{
    ...
    [Migration("20240319093203_TypePaiement")]
    partial class TypePaiement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResaTicket.Model.Cinema_Paiement", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TTypePaiementID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TTypePaiementID");

                    b.HasIndex("TypePaiementID");

                    b.ToTable("CinemaPaiement");
                });
            ...
            modelBuilder.Entity("ResaTicket.Model.TypePaiement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResaTicket.Model.Cinema_Paiement", b =>
                {
                    b.HasOne("ResaTicket.Model.Cinema", "TCinema")
                        .WithMany("LesCinemaPaiement")
                        .HasForeignKey("CinemaID");

                    b.HasOne("ResaTicket.Model.Langue", "TTypePaiement")
                        .WithMany()
                        .HasForeignKey("TTypePaiementID");

                    b.HasOne("ResaTicket.Model.TypePaiement", null)
                        .WithMany("LesCinemaPaiement")
                        .HasForeignKey("TypePaiementID");

                    b.Navigation("TCinema");

                    b.Navigation("TTypePaiement");
                });
            ...
            modelBuilder.Entity("ResaTicket.Model.Cinema", b =>
                {
                    b.Navigation("LesCinemaPaiement");
