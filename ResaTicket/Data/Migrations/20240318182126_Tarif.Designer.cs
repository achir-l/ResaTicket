...
namespace ResaTicket.Data.Migrations
{
    ...
    [Migration("20240318182126_Tarif")]
    partial class Tarif
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaSeance", b =>
                {
                    b.Property<int>("CinemasID")
                        .HasColumnType("int");

                    b.Property<int>("SeancesID")
                        .HasColumnType("int");

                    b.HasKey("CinemasID", "SeancesID");

                    b.HasIndex("SeancesID");

                    b.ToTable("CinemaSeance");
                });
            ...
            modelBuilder.Entity("ResaTicket.Model.Proposer", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaSeance", b =>
                {
                    b.HasOne("ResaTicket.Model.Cinema", null)
                        .WithMany()
                        .HasForeignKey("CinemasID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResaTicket.Model.Seance", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ResaTicket.Model.Proposer", b =>
                {
                    ...
                    b.HasOne("ResaTicket.Model.Tarif", "Tarif")
                        .WithMany()
